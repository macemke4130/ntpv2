...
const gamesTheadElement = document.querySelector("#games-table thead")! as HTMLButtonElement;
const gamesTbodyElement = document.querySelector("#games-table tbody")! as HTMLButtonElement;
...
const buildGamesTable = (gamesData: any) => {
  // Get headers
  ...
  gamesColumns.forEach((column: any) => {
    const thElement = document.createElement("th");
    thElement.setAttribute("scope", "col");
    thElement.innerText = column;
    theadTRElement.appendChild(thElement);
